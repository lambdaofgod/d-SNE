...
class DatasetGenerator:
    ...
    def download_file(self, url: str, storage_dir: str, chunk_size=1024):
    ...
    def unzip_file(self, file_path: str, clean_up: bool = True):
...
class MNIST(DatasetGenerator):
    ...
    def download(self,
        ...
        for url in [train_images_url, train_labels_url, test_images_url, test_labels_url]:
            file_path = self.download_file(url, self.root)
